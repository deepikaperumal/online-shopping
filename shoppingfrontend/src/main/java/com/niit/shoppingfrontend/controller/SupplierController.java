...
public class SupplierController {
	...
	public ModelAndView showSupplierProducts(@RequestParam(name = "operation", required = false) String operation) {

		ModelAndView mv = new ModelAndView("page");

		mv.addObject("userClickSupplierProducts", true);
	...
	public String handleProductSubmission(@Valid @ModelAttribute("product") Product mProduct, BindingResult results,
		...
		if (results.hasErrors()) {
			...
			model.addAttribute("userClickSupplierProducts", true);
			model.addAttribute("title", "Supplier Products");
		...
		return "redirect:/supplier/products?operation=product";
	}
	...
	public String handleSupplierSubmission(@ModelAttribute Supplier supplier) {
		
		supplierDAO.add(supplier);
		
		return "redirect:/supplier/products/?operation=category";
